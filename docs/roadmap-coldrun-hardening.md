...
- **`main` @ 0.8.98** — the quick-wins slices (0.8.81–0.8.94) + the cold-run bundle (consent/env/webport/devcve) + the S0 bootstrap agent-plugin pin (0.8.96) + the S1 headless agent-test evidence engine (0.8.97) + the S2 agent-trace-probe deployed-package runtime lens (0.8.98) + the S3 org-effective MCP tool-surface capture (0.8.99), all merged; suite **68 files / 1099 checks**, tag **HELD** (newest `v0.7.0`; `0.9.0` reserved pending the 0.8.95 clean cold run).
