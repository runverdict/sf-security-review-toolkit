...
- **`main` @ 0.8.97** — the quick-wins slices (0.8.81–0.8.94) + the cold-run bundle (consent/env/webport/devcve) + the S0 bootstrap agent-plugin pin (0.8.96) + the S1 headless agent-test evidence engine (0.8.97), all merged; suite **66 files / 1079 checks**, tag **HELD** (newest `v0.7.0`; `0.9.0` reserved pending the 0.8.95 clean cold run).
