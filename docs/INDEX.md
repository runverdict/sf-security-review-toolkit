...
| [roadmap-coldrun-hardening.md](roadmap-coldrun-hardening.md) | `ACTIVE` | The post-cold-run hardening backlog (B1 scans-before-fan-out — **shipped 0.8.45** (static substrate step before the audit + first-pass digest deferral + resume-ladder rung) · B2 throwaway-tier engines + container-isolated OpenAPI · B3 deterministic-band verdict-reflection · B4 PENDING labeling · B5 residual-shrinking · B6 prose · B7 gate-consolidation), with the genuinely-owner residual + locked decisions. |
