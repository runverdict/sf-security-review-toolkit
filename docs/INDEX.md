...
| [roadmap-deterministic-findings.md](roadmap-deterministic-findings.md) | `ACTIVE` | Provenance-typed findings; Phase 1 done, Phase 2 per-scanner adapters in progress (checkov/semgrep/bandit/njsscan shipped; gitleaks next). |
