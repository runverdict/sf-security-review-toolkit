...
| `/sf-security-review-toolkit:audit-codebase` | Multi-agent security audit of your codebase across 17 threat dimensions; every finding adversarially verified; incremental via a findings ledger | Automated (you read the report) |
...
The toolkit ships **14 skills**, **17 audit dimensions**, **8 scan families**, a deterministic
**Submission Completeness Index**, a sequenced **path-to-green**, and a core of **deterministic
engines in `harness/` guarded by 26 standing test files (222 checks)** that fail the build if a
...
- **Substantially verified, residual gaps flagged:** after the 2026-06-12
  ...
  121 of 158 baseline entries are `verified_primary` (confirmed
