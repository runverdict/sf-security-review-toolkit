...
│   ├── README.md
│   └── test-*.mjs                   # 55 dependency-free standing tests (688 checks) guarding the harness/ + hooks/ + CI hygiene
