...
│   ├── standup-stack.mjs            # 0.7.0 slice 3: consented stand-up of an isolated throwaway (node/python copy-in, dockerfile build, compose multi-container w/ loopback override; synth secrets, manifest); fails closed w/o consent
...
│   ├── README.md
│   └── test-*.mjs                   # 58 dependency-free standing tests (767 checks) guarding the harness/ + hooks/ + CI hygiene
