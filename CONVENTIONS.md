...
│   ├── README.md
│   └── test-*.mjs                   # 62 dependency-free standing tests (882 checks) guarding the harness/ + hooks/ + CI hygiene
